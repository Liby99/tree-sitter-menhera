...
enum {
  ...
  sym_expr_bin_op = 20,
  sym_expr_let = 21,
  sym_expr_function = 22,
  sym_expr_application = 23,
  sym_expr_unit = 24,
  sym_expr_compound = 25,
  sym_expr = 26,
};
...
static const char *ts_symbol_names[] = {
  ...
  [sym_expr_compound] = "expr_compound",
  [sym_expr] = "expr",
};
...
static uint16_t ts_parse_table[STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_expr_bin_op] = STATE(8),
    [sym_expr_let] = STATE(8),
    [sym_expr_function] = STATE(8),
    [sym_expr_application] = STATE(8),
    [sym_expr_unit] = STATE(9),
    [sym_expr_compound] = STATE(9),
    [sym_expr] = STATE(10),
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [27] = {.count = 1, .reusable = true}, REDUCE(sym_expr_unit, 1),
  [29] = {.count = 1, .reusable = true}, REDUCE(sym_expr_compound, 1),
  [31] = {.count = 1, .reusable = true}, REDUCE(sym_expr, 1),
  ...
  [45] = {.count = 1, .reusable = true}, REDUCE(sym_arguments, 1),
  ...
  [73] = {.count = 1, .reusable = true}, REDUCE(sym_expr_unit, 3),
  [75] = {.count = 1, .reusable = true}, REDUCE(sym_expr_bin_op, 3),
  ...
  [87] = {.count = 1, .reusable = true}, REDUCE(sym_expressions, 1),
  ...
  [97] = {.count = 1, .reusable = true}, REDUCE(sym_arguments, 3),
  ...
  [113] = {.count = 1, .reusable = true}, REDUCE(sym_expr_function, 5),
